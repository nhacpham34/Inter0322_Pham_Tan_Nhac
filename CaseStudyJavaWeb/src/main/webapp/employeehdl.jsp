            ...
            <div class=" pt-1">
                ...
                <form class="form_input display-block" method="post" action="/showEmployee">
                    ...
                    <div class="form-group form_input row ">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="name" class="form-control" id="inputNameEpl" placeholder="Nhập họ tên nhân viên">
                        </div>
                        <label for="inputDateEpl" class="col-sm-2 col-form-label">Ngày sinh:</label>
                        <div class="col-sm-4">
                            <input type="date" name="dateOfBirth" class="form-control" id="inputDateEpl" placeholder="Nhập ngày sinh...">
                        </div>
                    </div>
                    <div class="form-group form_input row">
                        <label for="inputIdCardEpl" class="col-sm-2 col-form-label">CMND/CCCD:</label>
                        <div class="col-sm-4">
                            <input type="text" name="idCard" class="form-control" id="inputIdCardEpl" placeholder="Nhập CMND..">
                        </div>
                        <label for="inputSdtEpl" class="col-sm-2 col-form-label">Số điện thoại:</label>
                        <div class="col-sm-4">
                            <input type="tel" name="sdt" class="form-control" id="inputSdtEpl" placeholder="Nhập số điện thoại...">
                        </div>
                    ...
                    <div class="form-group form_input row">
                        ...
                        <div class="col-sm-4">
                            <input type="email" name="email" class="form-control" id="inputEmailEpl" placeholder="Nhập Email...">
                        </div>
                    ...
                    <div class="form-group form_input row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="price" class="form-control" id="inputPriceEpl" placeholder="Nhập Lương...">
                        </div>
                    </div>
